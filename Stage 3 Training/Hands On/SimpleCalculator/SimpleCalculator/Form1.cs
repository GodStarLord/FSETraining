        ...
        public long CalculateIntegerResult(string operation, long num1, long num2)
        {
            ...
            try
            {
                if (txtResult.Text.Contains("+") || txtResult.Text.Contains("-") || txtResult.Text.Contains("*") || txtResult.Text.Contains("/") || txtResult.Text.Contains("%"))
                {
                    ...
                    {
                        case "plus":
                            resut = business.Addition(num1, num2);
                            //resut = num1 + num2;
                            break;
                        case "minus":
                            resut = business.Substraction(num1, num2);
                            //resut = num1 - num2;
                            break;
                        case "multiply":
                            resut = business.Multiplication(num1, num2);
                            //resut = num1 * num2;
                            break;
                        case "divide":
                            resut = business.Division(num1, num2);
                            //resut = num1 / num2;
                            break;
                        case "modulus":
                            resut = business.Modulus(num1, num2);
                            //resut = num1 % num2;
                            break;
                        default:
                            break;
